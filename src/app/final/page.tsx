        ...
        {playerData.preJoin && (
          <div className="mt-6 text-center">
            <button
              ...
              className="inline-flex items-center bg-white/5 rounded-2xl px-6 py-4 border border-white/10 text-white font-semibold transition-all duration-300 transform hover:scale-105"
            >
              ไปยัง Dashboard
            </button>
          </div>
